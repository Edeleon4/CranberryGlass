 ...
 * card.
 */
public class CranberryMenuActivity extends Activity {

    private GraphService.CompassBinder mCompassService;
    private boolean mResumed;

    private ServiceConnection mConnection = new ServiceConnection() {
        @Override
        public void onServiceConnected(ComponentName name, IBinder service) {
            if (service instanceof GraphService.CompassBinder) {
                mCompassService = (GraphService.CompassBinder) service;
                openOptionsMenu();
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bindService(new Intent(this, GraphService.class), mConnection, 0);
    }
