...
public class GraphService extends Service {
    ...
    private static final String LIVE_CARD_ID = "graph";
    ...
    private SensorNodes mSensorNodes;
    ...
    public void onCreate() {
        ...
        mSensorNodes = new SensorNodes(this);
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (mLiveCard == null) {
            ...
            mRenderer = new GraphRenderer(this, mOrientationManager, mSensorNodes);

            mLiveCard.setDirectRenderingEnabled(true).getSurfaceHolder().addCallback(mRenderer);

            // Display the options menu when the live card is tapped.
            Intent menuIntent = new Intent(this, CranberryMenuActivity.class);
